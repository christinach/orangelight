...
describe('AvailabilityUpdater', function() {
  ...
  test('extra Online availability added for CDL records that are reported as unavailable', () => {
    document.body.innerHTML = '<ul>'+
      '  <li data-availability-record="true" data-record-id="99125464716806421" data-holding-id="22919898220006421" data-aeon="false" data-bound-with="false">' +
      '    <span class="availability-icon" title="">Unavailable</span>' +
      '    <div class="library-location" data-location="true" data-record-id="99125464716806421" data-holding-id="22919898220006421">' +
      '      <span class="results_location">Firestone Library - Remote Storage (ReCAP): Firestone Library Use Only</span> » ' +
      '      <span class="call-number">MICROFILM ' +
      '        <a title="Where to find it" class="find-it" data-map-location="firestone$pf" data-blacklight-modal="trigger" aria-label="Where to find it" href="/catalog/99125464716806421/stackmap?loc=firestone$pf&amp;cn=MICROFILM"><span class="fa fa-map-marker" aria-hidden="true"></span></a> ' + 
      '      </span>' +
      '    </div>' +
      '  </li>' +
      '  <li>' +
      ...
      '  </li>' +
      '  <li class="empty" data-record-id="99125464716806421">' +
      '    <a class="availability-icon more-info" title="Click on the record for full availability info" data-toggle="tooltip" href="/catalog/99125464716806421"></a>' +
      '  </li>' +
      '</ul>';
    ...
    const availability_response = {
      "99125464716806421": {
        "22919898220006421": {
        "on_reserve": "N",
        "location": "firestone$pf",
        "label": "Firestone Library - Remote Storage (ReCAP): Firestone Library Use Only",
        "status_label": "Unavailable",
        "copy_number": null,
        "cdl": true,
        "temp_location": false,
        "id": "22919898220006421"
        }
      }
    };
    const holding_data = availability_response["99125464716806421"]["22919898220006421"];

    const cdl_element = $("*[data-availability-cdl='true']")[0];
    const av_element = $(`*[data-availability-record='true'][data-record-id='99125464716806421'][data-holding-id='22919898220006421'] .availability-icon`);

    let u = new updater;
    u.id = '99125464716806421';

    expect(cdl_element.textContent).not.toContain('Online');
    u.apply_availability_label(av_element, holding_data, true);
    console.log(cdl_element.textContent)
